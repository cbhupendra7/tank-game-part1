...
public class MainView {
    ...
    private final CardLayout mainPanelLayout; // it allows number of views to register called cards, helps to display which card
    ...
    public MainView(GameDriver.PrintListener printlistener, GameDriver.EscapeListener escapelistener) {
        ...
        KeyControlListener bhupen = new KeyControlListener();
        mainJFrame.addKeyListener(bhupen);
        mainJFrame.addKeyListener(escapelistener);
        ...
        StartMenuView startMenuView = new StartMenuView("Start Game", printlistener);
        mainPanel.add(startMenuView, Screen.START_MENU_SCREEN.getScreenName());

        StartMenuView endMenuView = new StartMenuView("Restart Game", printlistener);
